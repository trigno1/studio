...
<p align="center">
  A modern and responsive portfolio website built with <b>Next.js</b>, <b>TypeScript</b>, and <b>Tailwind CSS</b>.
</p>

---

## 🔗 Live Demo  
👉 [Portfolio Website](https://portfoliotanishsunitapareek.vercel.app/)
...
I love turning **complex problems into simple, elegant solutions** through **UI/UX-focused development**. My work blends **design thinking and clean code**, ensuring both functionality and aesthetics.  

Currently, I’m seeking opportunities to:  
- 📌 Grow as a **developer and designer**  
- 🌍 Contribute to impactful **open-source & community-driven projects**  
...
- ⚡ **Modern Tech Stack** – Built with Next.js, TypeScript, and Tailwind for high performance.  
- 💼 **Project Showcase** – Highlighting my work with links to demos & source code.  
- 🎨 **Interactive UI** – Smooth animations and transitions for engaging user experience.  
- 🔍 **SEO Optimized** – Clean structure with better search engine visibility.  
- 🌙 **Dark/Light Mode** (if enabled in your portfolio).  

---

## 🖼️ Portfolio Sections Preview  
...
* 🐙 GitHub: [trigno1](https://github.com/trigno1)
