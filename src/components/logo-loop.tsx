...
import type { CSSProperties, FC, HTMLAttributeAnchorTarget, ReactNode, RefObject } from 'react';
...
export type LogoItem = ItemWithNode | ItemWithImage;
...
export const LogoLoop: FC<LogoLoopProps> = memo(
  ({
    logos,
    speed = 120,
    direction = 'left',
