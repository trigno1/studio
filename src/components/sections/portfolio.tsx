...
const portfolioItems = [
    ...
    { id: 5, title: 'Racing Lines', category: 'Content', image: 'https://placehold.co/600x400.png', hint: 'blog article', description: 'A content series breaking down complex topics in motorsport technology for a general audience. Focused on SEO and long-form technical writing.', tags: ['Writing', 'SEO'] },
    { id: 6, title: 'Web3 Wallet', category: 'Blockchain', image: 'https://placehold.co/600x400.png', hint: 'digital wallet', description: 'A secure mobile wallet for managing digital assets on the Ethereum blockchain. Designed with a user-first approach for both new and experienced crypto users.', tags: ['React Native', 'Web3'] },
];
