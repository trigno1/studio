...
const portfolioItems = [
    ...
    { id: 4, title: 'Code for Bharat Season 2 Hackathon Website', category: 'Web Development', image: 'https://picsum.photos/600/400', hint: 'hackathon website event', description: 'Led the design and development of the official website for the Code for Bharat Season 2 hackathon. The site served as the main portal for information, registration, and updates for over 10,000 participants.', tags: ['Next.js', 'React', 'Tailwind CSS', 'Vercel'] },
];
